...
describe("MedicalStorage", () => {
    ...
    describe("Register doctor", () => {
        ...
        it("Emits a Register doctor event", async () => {
          // Attempt to register the same doctor again
    ...
    describe("Add patient", () => {
        beforeEach(async () => {
            await medical.connect(user0).addPatient("Ram", 21, "dengue");
        });
        ...
        it("The patient is added", async () => {
            ...
            expect(patientDetails[1]).to.equal(21);
            expect(patientDetails[2]).to.equal("dengue");
        });

        it("Emits an add patient event", async () => {
          await expect(medical.connect(user0).addPatient("Ram", 21, "dengue"))
